...
import org.springframework.data.aot.sample.SimpleTxComponentCrudRepository.MyComponentTxRepo;
...
@EnableRepositories(includeFilters = { @Filter(type = FilterType.ASSIGNABLE_TYPE, value = MyComponentTxRepo.class) },
		basePackageClasses = SimpleTxComponentCrudRepository.class, considerNestedRepositories = true)
public class SimpleTxComponentCrudRepository {
